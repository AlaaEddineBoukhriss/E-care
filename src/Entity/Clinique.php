...
class Clinique
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=CliniqueLike::class, mappedBy="cliniquelike")
     */
    private $likes;
    ...
    public function __toString() 
{
    ...
    /**
     * @return Collection|CliniqueLike[]
     */
    ...
    public function addLike(CliniqueLike $like): self
    {
        if (!$this->likes->contains($like)) {
            $this->likes[] = $like;
            $like->setCliniquelike($this);
        }

        return $this;
    }

    public function removeLike(CliniqueLike $like): self
    {
        if ($this->likes->removeElement($like)) {
            // set the owning side to null (unless already changed)
            if ($like->getCliniquelike() === $this) {
                $like->setCliniquelike(null);
            }
        }
